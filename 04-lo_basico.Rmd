...
Habiendo introducido los operadores lógicos más básicos arriba, aprovecharemos la oportunidad para mostrar que podemos combinarlos y resumiremos en la tabla 1 más operadores lógicos. Veamos un ejemplo de cómo combinar operadores lógicos:  
...
Finalizaremos el resumen de las operaciones lógicas con la tabla 4.2, en donde aparecen los operadores de negación, disyunción y conjunción.  
