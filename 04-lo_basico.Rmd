...
### Argumentos, Nombres y Valores por Defecto en las Funciones
...
round(3.141592, 2)
```
En esta expresión, tenemos 2 argumentos al interior de la función round: el primer argumento que corresponde al valor a ser redondeado (es decir, 3.141592) y el segundo argumento es el nuumero de decimales a aproximar (es decir, 2) y, ambos, están separados por una coma.
