...
## Orden de las Operaciones Matemáticas en R
...
(5 + 5) * 12 
```
En este bloque primero se suman los dos nuumeros que están al interior del paréntesis (es decir `5 + 5 = 10`) y luego el resultado se multiplica con `12` para obtener `120`.  
