...
A continuación, dejo algunos ejercicios para aquellos que quieran poner en práctica lo descrito aquí. Para esto, deberán haber cargado la base de datos desde la web y haber corrido completamente las instrucciones. Si experimentan algún error, probablemente será a porque no corrieron apropiadamente los comandos aquí mostrados (o algún error de escritura). Ademas, se asume que ustedes ya instalaron el lenguaje de programación R y RStudio (Para más información ir al [Capítulo 3](#chapter_3). 
