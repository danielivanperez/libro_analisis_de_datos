...
```
A diferencia de la variable `promedio` para las calificaciones de los estudiantes, ahora nos centraremos en un constructo llamado “emociones académicas”, la cual se enfoca en consultar a los estudiantes por una variedad de emociones, tanto positivas como negativas, que son sentidas particularmente cuando los estudiantes están en clases. Los 12 ítems son resumidos en la Tabla 1. 
...
Con el fin de mantener la simplicidad de los ejemplos y centrarnos en el uso de R para el análisis de datos, procederemos a construir las variables a partir de las sumatorias de los valores por filas, sin explorar sus valores de confiabilidad, que sería un paso necesario en este caso. 
