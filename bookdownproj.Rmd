...
title.innerHTML = '<img src="/Users/danielperez/Desktop/book/libro_analisis_de_datos/images/rsz_dani_r.png" alt="Test Image">' + title.innerHTML
```
...
```{=html}
<p align="center">
  <img width="280" height="200" src="mundo_mejor.jpg">
</p>
<p align="center">
Imagen 1. Ilustración de la comunidad de R interactuando en el mundo virtual.
</p>
```
...
<!--chapter:end:02-aplicando_r.Rmd-->
...
<!--chapter:end:03-instalando_r.Rmd-->
...
<!--chapter:end:20-anexo_uno_l_basico_2.Rmd-->

# Breve Biografía {-}

Daniel Pérez Zapata nació en Arica, Chile. Estudió Psicología en la Universidad de Tarapacá (2009) y también se graduó de Magister en Ciencias Sociales Aplicadas (2012) en la misma universidad. Luego, realizó un Máster en Psicología Cognitiva (2016) en la Universidad de Queensland (Australia), bajo la guía de las profesoras Virginia Slaughter y Julie Henry. Actualmente se encuentra completando un PhD en Psicología Cognitiva en la Universidad de Birmingham (Reino Unido), supervisado por el profesor y Dr. Ian Apperly y por el Dr. Ian Charest. Para saber más sobre su trabajo académico visita este [link](https://www.danielperezzapata.com){target="_blank"}. 

<!--chapter:end:99-bio.Rmd-->
